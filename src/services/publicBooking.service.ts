...
export interface PublicReservationDetail {
  ...
  /** Full ordered service list for multi-service appointments. The backend
   *  resolves it from productIds[]; `product` remains the lead service. */
  services?: Array<{ id: string; name: string; price: number | null; duration: number | null }>
