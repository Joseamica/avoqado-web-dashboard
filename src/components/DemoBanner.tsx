  ...
  return (
    <>
      ...
      <div className="mx-4 mt-4 mb-2 rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-700 dark:via-purple-700 dark:to-pink-700 p-0.5">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4 flex-1 min-w-0">
                ...
                <div className="flex-shrink-0">
                  <div className="relative">
                    ...
                    <div className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-500 dark:via-purple-500 dark:to-pink-500 p-3 rounded-full">
              ...
              <div className="flex items-center gap-3 flex-shrink-0">
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 hover:from-blue-700 hover:via-purple-700 hover:to-pink-700 text-white font-semibold shadow-md hover:shadow-xl transition-all duration-300 group"
                >
