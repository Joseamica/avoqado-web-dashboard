  ...
  ({ className, to, state, children, ...props }, ref) => {
    ...
    return (
      <tr
        ...
        onClick={handleClick}
        className={cn(
          'border-b transition-colors hover:bg-zinc-100/50 data-[state=selected]:bg-zinc-100 dark:hover:bg-zinc-800/50 dark:data-[state=selected]:bg-zinc-800 cursor-pointer',
          className,
        )}
        {...props}
      >
