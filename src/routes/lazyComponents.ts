...
export const Attendance = lazyWithRetry(() => import('@/pages/Attendance/Attendance'))
...
export const VenueFiscalProfile = lazyWithRetry(() => import('@/pages/Venue/Edit/FiscalProfile'))
export const VenueIntegrations = lazyWithRetry(() => import('@/pages/Venue/Edit/Integrations'))
export const VenueActivityLog = lazyWithRetry(() => import('@/pages/Venue/VenueActivityLog'))
...
export { default as PartnerKeys } from '@/pages/Superadmin/PartnerKeys'
...
export const Ecommerce = lazyWithRetry(() => import('@/pages/Ecommerce/Ecommerce'))
...
export const IncomeStatement = lazyWithRetry(() => import('@/pages/Reports/IncomeStatement'))
...
export const PlayTelecomOrgComisiones = lazyWithRetry(() => import('@/pages/playtelecom/Organization/OrgComisionesPage'))
export const PlayTelecomManualSalesUpload = lazyWithRetry(() => import('@/pages/playtelecom/ManualSales/ManualSalesUpload'))
