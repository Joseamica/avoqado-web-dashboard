...
const FOOD_SERVICE_PACK: DashboardPack = {
  ...
  rows: [
    { id: 'fs-bestsellers-staff', layout: 'split', items: ['best_selling_products', 'staff_ranking'], priority: 1 },
    { id: 'fs-revenue', layout: 'full', items: ['revenue_trends'], priority: 2 },
    { id: 'fs-peak-kitchen', layout: 'split', items: ['peak_hours', 'kitchen_performance'], priority: 3 },
    { id: 'fs-heatmap-weekday', layout: 'split', items: ['sales_heatmap', 'sales_by_weekday'], priority: 4 },
    { id: 'fs-staff-table', layout: 'split', items: ['staff_efficiency', 'table_efficiency'], priority: 5 },
    { id: 'fs-tips', layout: 'full', items: ['tips_over_time'], priority: 6 },
    { id: 'fs-satisfaction', layout: 'full', items: ['customer_satisfaction'], priority: 7 },
    { id: 'fs-channel-category', layout: 'split', items: ['channel_mix', 'category_mix'], priority: 8 },
    { id: 'fs-aov-orders', layout: 'split', items: ['aov_trends', 'order_frequency'], priority: 9 },
    { id: 'fs-payment-methods', layout: 'full', items: ['payment_methods'], priority: 10 },
...
const RETAIL_PACK: DashboardPack = {
  ...
  rows: [
    { id: 'rt-bestsellers-staff', layout: 'split', items: ['best_selling_products', 'staff_ranking'], priority: 1 },
    { id: 'rt-revenue', layout: 'full', items: ['revenue_trends'], priority: 2 },
    { id: 'rt-weekday', layout: 'full', items: ['sales_by_weekday'], priority: 3 },
    { id: 'rt-category-channel', layout: 'split', items: ['category_mix', 'channel_mix'], priority: 4 },
    { id: 'rt-staff', layout: 'full', items: ['staff_efficiency'], priority: 5 },
    { id: 'rt-discount-products', layout: 'split', items: ['discount_analysis', 'product_analytics'], priority: 6 },
    { id: 'rt-aov-orders', layout: 'split', items: ['aov_trends', 'order_frequency'], priority: 7 },
    { id: 'rt-satisfaction', layout: 'full', items: ['customer_satisfaction'], priority: 8 },
    { id: 'rt-payment-methods', layout: 'full', items: ['payment_methods'], priority: 9 },
  ],
}
