...
export default function ProductId() {
  ...
  const saveProduct = useMutation({
    mutationFn: async (formValues: any) => {
      ...
      // Venta por peso: fijar unidad a KILOGRAM (aunque no rastree inventario). El
      // backend también lo fuerza; lo enviamos explícito para dejar el catálogo consistente.
      if (formValues.soldByWeight === true) {
      ...
      <nav className="sticky top-14 bg-card h-14 z-10 shadow-sm flex items-center space-x-6 lg:space-x-8 border-b border-border px-6">
        <a
          ...
          className={cn(
            ...
            currentTab === 'details' ? 'text-foreground border-primary' : 'text-muted-foreground border-transparent hover:text-primary',
          )}
        >
        ...
        <a
          ...
          className={cn(
            'text-sm font-medium transition-colors py-4 border-b-2',
            currentTab === 'inventory' ? 'text-foreground border-primary' : 'text-muted-foreground border-transparent hover:text-primary',
          )}
        >
        ...
        <a
          ...
          className={cn(
            'text-sm font-medium transition-colors py-4 border-b-2',
            currentTab === 'modifiers' ? 'text-foreground border-primary' : 'text-muted-foreground border-transparent hover:text-primary',
          )}
        >
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                type="number"
                                step="0.01"
                                placeholder={t('products.detail.inventory.currentStockPlaceholder')}
                                className="max-w-96"
                                {...field}
                              />
                            </FormControl>
                            ...
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  type="number"
                                  step="0.01"
                                  placeholder={t('products.detail.inventory.costPerUnitPlaceholder')}
                                  {...field}
                                />
                              </FormControl>
                            ...
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  type="number"
                                  step="1"
                                  placeholder={t('products.detail.inventory.reorderPointPlaceholder')}
                                  {...field}
                                />
                              </FormControl>
                    ...
                    <div className="pl-4 border-l-2 border-primary space-y-4">
                      {recipeData && recipeData.lines && recipeData.lines.length > 0 ? (
                        ...
                        <div className="p-4 rounded-lg bg-orange-50 dark:bg-orange-950/50 border border-orange-200 dark:border-orange-800">
                          <p className="text-sm text-orange-800 dark:text-orange-200">{t('products.detail.inventory.noIngredients')}</p>
                          <Button
                            type="button"
                            variant="outline"
