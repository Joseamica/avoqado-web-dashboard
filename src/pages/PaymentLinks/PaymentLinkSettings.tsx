        ...
        <div className="space-y-10">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between py-2">
                ...
                <Switch checked={dashboardNotifs} onCheckedChange={setDashboardNotifs} className="cursor-pointer" />
              </div>
              <div className="flex items-center justify-between py-2">
                <span className="text-sm">{t('settings.tpvNotifications')}</span>
                <Switch checked={tpvNotifs} onCheckedChange={setTpvNotifs} className="cursor-pointer" />
              </div>
            </div>

            <p className="text-xs text-muted-foreground">
              {t('settings.editEmail')}{' '}
              <span className="underline font-medium text-foreground cursor-pointer">{t('settings.accountSettings')}</span>
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-1 opacity-50">
              <button disabled className="w-full flex items-center justify-between py-3 text-left">
                <div>
              ...
              <button disabled className="w-full flex items-center justify-between py-3 text-left">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">15%, 20%, 25%</p>
                </div>
                <ChevronRight className="h-4 w-4 text-muted-foreground" />
              </button>
            </div>
          ...
          <section className="space-y-4">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <Switch checked={customerNotes} onCheckedChange={setCustomerNotes} className="cursor-pointer" />
            </div>
          </section>
