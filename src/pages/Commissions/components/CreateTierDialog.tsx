...
import type { CommissionTier, TierType, TierPeriod } from '@/types/commission'
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-[500px]">
				<DialogHeader>
					<DialogTitle>
						{isEditing ? t('tiers.edit') : t('tiers.create')}
					</DialogTitle>
					<DialogDescription>
						{isEditing
							? t('tiers.editDescription')
							: t('tiers.createDescription')}
					</DialogDescription>
				</DialogHeader>
