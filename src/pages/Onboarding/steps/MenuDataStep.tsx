...
import { X, Plus, Upload, Download, CheckCircle2, AlertCircle, Loader2, Info } from 'lucide-react'
      ...
      <Card className="border-blue-200 bg-blue-50 dark:border-blue-900 dark:bg-blue-950/50">
        <CardContent className="pt-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-blue-900 dark:text-blue-100">{t('menuData.actions.skip')}</p>
              <p className="mt-1 text-sm text-blue-700 dark:text-blue-300">{t('menuData.actions.skipDescription')}</p>
            </div>
          </div>
        </CardContent>
      </Card>
