 ...
 *
 * Diseño: superficies suaves tintadas (bg-muted), sin bordes de caja; el color
 * (verde entra / rojo sale) guía el significado, no decora. Alineado al lenguaje
 * visual del dashboard de Avoqado.
 */
                  ...
                  return (
                    <div key={m.id ?? i} className="flex items-start justify-between gap-3 px-4 py-3 transition-colors hover:bg-muted/60">
                      <div className="flex min-w-0 items-start gap-3">
                        <span
                          className={cn(
                            ...
                            outgoing ? STAT_TONE.out : STAT_TONE.in,
                          )}
                          aria-hidden
                        >
                      ...
                      <div className="flex shrink-0 flex-col items-end gap-1">
                        ...
                        {m.status && (
                          <span className="rounded-full bg-muted px-2 py-0.5 text-[10px] font-medium text-muted-foreground">{m.status}</span>
                        )}
                      </div>
                    </div>
                  )
