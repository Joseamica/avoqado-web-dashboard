...
import { AlertCircle, ArrowRight, Check, CheckCircle2, Copy, Link2, Plus, Power, ShoppingCart, Sparkles, Trash2, Unlink, XCircle } from 'lucide-react'
...
function McpIntegrationCard() {
  ...
  const copy = async (value: string, which: 'url' | 'cli') => {
    try {
      ...
      // clipboard can fail on insecure origins — no-op; the value stays visible to copy manually
    }
  }
